...
<div style="display: flex;">
  <div style="width: 50%; margin-right: 1em;">
    ...
    <figcaption style="text-align: left;">"Bee" hummingbirds have highly modified feathers that make tonal sounds when air passes over them at the right speed</figcaption>
  </div>
  <div style="flex: 1; display: flex; flex-direction: column;">
